# Phase 18: Integration and Distribution - Research
...
**Primary recommendation:** Phase 18 is two tasks — (1) run the three manual integration tests and document results; (2) build the v1.2 release via the existing `bundle-release` skill, upload the NSIS installer to VirusTotal, compare against the v1.1 baseline, and gate distribution on no new detections.
...
**Installation:** No new dependencies. Phase 18 is verification-only.
