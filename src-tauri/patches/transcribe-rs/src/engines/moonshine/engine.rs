...
pub struct MoonshineModelParams {
    ...
    /// Optional execution providers (e.g. CUDA, DirectML). Defaults to CPU if None.
    pub execution_providers: Option<Vec<ort::execution_providers::ExecutionProviderDispatch>>,
}

impl Default for MoonshineModelParams {
    fn default() -> Self {
        Self {
...
impl TranscriptionEngine for MoonshineEngine {
    ...
    fn load_model_with_params(
        ...
        self.model = Some(MoonshineModel::new(model_path, params.variant, params.execution_providers)?);
