...
impl SenseVoiceModel {
    ...
    pub fn new(model_dir: &Path, quantized: bool, providers: Option<Vec<ort::execution_providers::ExecutionProviderDispatch>>) -> Result<Self, SenseVoiceError> {
        ...
        let session = Self::init_session(&model_path, providers.as_deref())?;
    ...
    fn init_session(path: &Path, providers: Option<&[ort::execution_providers::ExecutionProviderDispatch]>) -> Result<Session, SenseVoiceError> {
